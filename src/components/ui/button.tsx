    ...
    return (
      <Comp
        className={cn(
          ...
          {
            "bg-primary text-white hover:bg-primary/90 border-2 border-primary hover:border-primary/90": variant === "default",
            "bg-gray-100 text-gray-900 hover:bg-gray-200 border-2 border-gray-100 hover:border-gray-200": variant === "secondary",
            "border-2 border-gray-200 bg-white text-gray-900 hover:bg-gray-50 hover:border-gray-300": variant === "outline",
